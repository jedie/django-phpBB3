...
#    # forum_id = models.IntegerField()
    #    forum = models.ForeignKey("Forum",# to_field="forum_id",
#        # mediumint(8) unsigned
#        default=0,
#        help_text="{{fk|forums|forum_id}}"
#    )
#    # auth_option_id = models.IntegerField()
    #    auth_option = models.ForeignKey("AclOption",# to_field="auth_option_id",
#        # mediumint(8) unsigned
#        default=0,
#        help_text="{{fk|acl_options|auth_option_id}}"
#    )
#    # auth_role_id = models.IntegerField()
    #    auth_role = models.ForeignKey("AclRole",# to_field="role_id",
#        # mediumint(8) unsigned
#        default=0,
...
class User(models.Model):
    ...
    user_perm_from = models.ForeignKey("User", db_column="user_perm_from", # to_field="user_id",
        # mediumint(8) unsigned
        default=0,
    ...
    user_rank = models.ForeignKey("Rank", db_column="user_rank", # to_field="rank_id",
        # mediumint(8) unsigned
        default=0,
...
class Attachment(models.Model):
    ...
    post_msg = models.ForeignKey("Post", # to_field="post_id",
        # mediumint(8) unsigned
        default=0,
        help_text="{{fk|posts|post_id}}"
    )
    # topic_id = models.IntegerField()
    topic = models.ForeignKey("Topic", # to_field="topic_id",
        # mediumint(8) unsigned
        default=0,
    ...
    poster = models.ForeignKey("User", # to_field="user_id",
        # mediumint(8) unsigned
        default=0,
        help_text="{{fk|users|user_id}}"
    )
...
class Privmsg(models.Model):
    ...
    icon = models.ForeignKey("Icon", # to_field="icon_id",
        # mediumint(8) unsigned
        default=0,
...
class Topic(models.Model):
    ...
    topic_poster = models.ForeignKey("User", db_column="topic_poster", # to_field="user_id",
        # mediumint(8) unsigned
        default=0,
        help_text="{{fk|users|user_id}}"
    )
    ...
    topic_first_post = models.ForeignKey("Post", related_name='+', # to_field="post_id",
        # mediumint(8) unsigned
        default=0,
        help_text="{{fk|posts|post_id}}"
    )
    ...
    topic_last_post = models.ForeignKey("Post", related_name='+', # to_field="post_id",
        # mediumint(8) unsigned
        default=0,
        help_text="{{fk|posts|post_id}}"
    )
    # topic_last_poster_id = models.IntegerField()
    topic_last_poster = models.ForeignKey("User", related_name='+', # to_field="user_id",
        # mediumint(8) unsigned
        default=0,
        help_text="{{fk|users|user_id}}"
    )
    ...
    topic_bumper = models.ForeignKey("User", related_name='+', db_column="topic_bumper", # to_field="user_id",
        # mediumint(8) unsigned
        default=0,
        help_text="{{fk|users|user_id}}"
    )
